...
<!-- 隐藏表单项：用于传递CartServlet中需要的相关参数 -->
				...
				<div style="margin:0 auto;width:950px;">
					<div class="col-md-6">
						<img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="${ pageContext.request.contextPath }/${ productBean.pimage}">
					</div>

					<div class="col-md-6">
						<div><strong>${ productBean.pname }</strong></div>
						<div style="border-bottom: 1px dotted #dddddd;width:350px;margin:10px 0 10px 0;">
							<div>编号：${ productBean.pid }</div>
						</div>

						<div style="margin:10px 0 10px 0;">商城价: <strong style="color:#ef0101;">￥：${ productBean.shop_price }元</strong> 参 考 价： <del>￥${ productBean.market_price }元</del>
						</div>
