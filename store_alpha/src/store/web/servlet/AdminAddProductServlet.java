...
public class AdminAddProductServlet extends HttpServlet {
	...
	/**
	 * 对新增的Product信息进行处理： 上传文件(图片)栏 + 非上传文件栏
	 *  * 利用upFile技术处理上传
	 */
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			productBean.setPid(UUIDUtils.getUUID());
	...
	/**
	 * 定义一个类：用于按照浏览器来获取上传文件的名称+后缀
	 *  - edge的header:  
	 *  	 form-data; name="upload"; filename="C:\Users\小土狗\Pictures\Saved Pictures\iu1.jpg"
	 *  - chrome/firefox的header: 
	 *  	form-data; name="upload"; filename="iu1.jpg"
	 */
